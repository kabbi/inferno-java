/*
 * @(#)MimeTable.java	1.12 97/04/08 James Gosling
 * 
...
public class MimeTable implements FileNameMap {
	...
	if (defaultInstance == null) {
	    ...
	    URLConnection.fileNameMap = defaultInstance;
	}
	...
	try {
	    ...
	    // The default table file was not found?
	    System.err.println("MimeTable.load: file = " +
			       file.getPath() +
			       ", " +
			       e);
	    e.printStackTrace();
	    // The table will be empty since this is called from the
	    // constructor.
	    return;
	}
